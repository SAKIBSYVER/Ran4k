...
#----------------------------------------------------------------------------------------------------------
#CREATE BY : SAKIB HASAN
#WHATSAPP : +8801708972860
#GITHUB : https://github.com/SAKIBSYVER 
#----------------------------------------------------------------------------------------------------------
...
logo = ("""\033[1;37m
 ...
 | (___   /  \  | ' /  | | | |_) |          
  \___ \ / /\ \ |  <   | | |  _ <           
  ____) / ____ \| . \ _| |_| |_) |          
 |_____/_/____\_\_|\_\_____|____/___ ______ 
 |______|______|______|______|______|______|
                                            
==================================================
[тАв] AUTHOR    : SAKIB HASAN
[тАв] TOOLS     : RANDOM CLONE
[тАв] TYPE      : FREE
[тАв] FACEBOOK  : Sakibul hasan
[тАв] WHATSAPP  : +8801708972860
==================================================""")
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[INNOCENT]├Ч[%s/%s]├Ч[OK-%s]├Ч[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
